...
// פונקציה להגדרת האתר לעבודה במחשב בלבד
function checkIfMobile() {
    // הגדרת האתר לעבודה במחשב בלבד
    ...
    console.log('האתר מוגדר לעבודה במחשב בלבד');
}

// פונקציה ריקה לתאימות - האתר מיועד למחשב בלבד
function setupTouchEvents() {
    // אין צורך בהגדרת אירועי מגע כי האתר מיועד למחשב בלבד
    console.log('האתר מיועד לשימוש במחשב בלבד');
}
