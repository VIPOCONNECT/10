...
function calculatePrice() {
  ...
  if (totalParticipants < 200) {
    discountPercent = 10; // 10% הנחה עד 200 משתתפים
  } else if (totalParticipants < 300) {
    discountPercent = 15; // 15% הנחה עד 300 משתתפים
  } else if (totalParticipants < 400) {
    discountPercent = 20; // 20% הנחה עד 400 משתתפים
  } else {
    discountPercent = 25; // 25% הנחה מעל 400 משתתפים
  }
